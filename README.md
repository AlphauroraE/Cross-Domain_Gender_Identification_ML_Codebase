...
4. The experiments require certain parameters. To save space, specify them in dictionaries of the below specified formats:
    ...
    ex. test1_info = {'raw': fast_b_raw, 'path': fast_b_path, 'fora': 'FAST', 'set': 'FASTB', 'filename': 'FASTA-FASTB_Scene_Pos'}
  
    ex. experiment_info = {'relative_info': 'Scene', 'posorvel_info': 'Pos', 'subsample_info': ''}
